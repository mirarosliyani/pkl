...
<body>
	...
	<header>
		...
		<div class="container">
			<a class="logo" href="/"><img src="{{ ('assets/frontend/images/logo-black.png')}}" alt="Logo"></a>
			...
			<div class="row">
				...
				<div class="col-md-12 col-lg-8">
					...
					<div class="row">
						...
						<div class="col-sm-6">
							<img src="{{ ('assets/frontend/images/recent-news-1-600x450.jpg')}}" alt="">
						...
						<div class="col-sm-6">
							<a class="oflow-hidden pos-relative mb-20 dplay-block" href="#">
								<div class="wh-100x abs-tlr"><img src="{{ ('assets/frontend/images/polular-1-100x100.jpg')}}" alt=""></div>
							...
							<a class="oflow-hidden pos-relative mb-20 dplay-block" href="#">
								<div class="wh-100x abs-tlr"><img src="{{ ('assets/frontend/images/polular-2-100x100.jpg')}}" alt=""></div>
								<div class="ml-120 min-h-100x">
									<h5><b>Bitcoin Billionares Hidding in Plain Sight</b></h5>
									<h6 class="color-lite-black pt-10">by <span class="color-black"><b>Danile Palmer,</b></span> Jan 25, 2018</h6>
								</div>
							...
							<a class="oflow-hidden pos-relative mb-20 dplay-block" href="#">
								<div class="wh-100x abs-tlr"><img src="{{ ('assets/frontend/images/polular-3-100x100.jpg')}}" alt=""></div>
								<div class="ml-120 min-h-100x">
									<h5><b>Bitcoin Billionares Hidding in Plain Sight</b></h5>
									<h6 class="color-lite-black pt-10">by <span class="color-black"><b>Danile Palmer,</b></span> Jan 25, 2018</h6>
								</div>
							...
							<a class="oflow-hidden pos-relative mb-20 dplay-block" href="#">
								<div class="wh-100x abs-tlr"><img src="{{ ('assets/frontend/images/polular-4-100x100.jpg')}}" alt=""></div>
								<div class="ml-120 min-h-100x">
									<h5><b>Bitcoin Billionares Hidding in Plain Sight</b></h5>
									<h6 class="color-lite-black pt-10">by <span class="color-black"><b>Danile Palmer,</b></span> Jan 25, 2018</h6>
								</div>
					...
					<div class="row">
						...
						<div class="col-sm-6">
							<img src="{{ ('assets/frontend/images/crypto-news-6-600x450.jpg')}}" alt="">
							<h4 class="pt-20"><a href="#"><b>2017 Market Performance: <br/>Crypto vs.Stock</b></a></h4>
						...
						<div class="col-sm-6">
							<img src="{{ ('assets/frontend/images/crypto-news-5-600x450.jpg')}}" alt="">
							<h4 class="pt-20"><a href="#"><b>2017 Market Performance: <br/>Crypto vs.Stock</b></a></h4>
							<ul class="list-li-mr-20 pt-10 mb-30">
								<li class="color-lite-black">by <a href="#" class="color-black"><b>Olivia Capzallo,</b></a>
								Jan 25, 2018</li>
						...
						<div class="col-sm-6">
							<img src="{{ ('assets/frontend/images/crypto-news-4-600x450.jpg')}}" alt="">
							<h4 class="pt-20"><a href="#"><b>2017 Market Performance: <br/>Crypto vs.Stock</b></a></h4>
							<ul class="list-li-mr-20 pt-10 mb-30">
								<li class="color-lite-black">by <a href="#" class="color-black"><b>Olivia Capzallo,</b></a>
								Jan 25, 2018</li>
						...
						<div class="col-sm-6">
							<img src="{{ ('assets/frontend/images/crypto-news-3-600x450.jpg')}}" alt="">
							<h4 class="pt-20"><a href="#"><b>2017 Market Performance: <br/>Crypto vs.Stock</b></a></h4>
							<ul class="list-li-mr-20 pt-10 mb-30">
								<li class="color-lite-black">by <a href="#" class="color-black"><b>Olivia Capzallo,</b></a>
								Jan 25, 2018</li>
						...
						<div class="col-sm-6">
							<img src="{{ ('assets/frontend/images/crypto-news-2-600x450.jpg')}}" alt="">
							<h4 class="pt-20"><a href="#"><b>2017 Market Performance: <br/>Crypto vs.Stock</b></a></h4>
							<ul class="list-li-mr-20 pt-10 mb-30">
								<li class="color-lite-black">by <a href="#" class="color-black"><b>Olivia Capzallo,</b></a>
								Jan 25, 2018</li>
						...
						<div class="col-sm-6">
							<img src="{{ ('assets/frontend/images/crypto-news-1-600x450.jpg')}}" alt="">
				...
				<div class="col-md-6 col-lg-4">
					<div class="pl-20 pl-md-0">
						...
						<div class="mtb-50 pos-relative">
							<img src="{{ ('assets/frontend/images/banner-1-600x450.jpg')}}" alt="">
