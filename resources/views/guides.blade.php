		...
		<div class="container">
			<div class="row">
				...
				<div class="col-md-12 col-lg-8">
					<img src="{{ ('assets/frontend/images/slider-1-1200x900.jpg')}}" alt="">
					...
					<div class="sided-70 mb-40">
						...
						<div class="s-left rounded">
							<img src="{{ ('assets/frontend/images/profile-3-120x120.jpg')}}" alt="">
						</div><!-- s-left -->
					...
					<div class="sided-70 ml-100 ml-xs-20 mb-40">
						...
						<div class="s-left rounded">
							<img src="{{ ('assets/frontend/images/profile-1-120x120.jpg')}}" alt="">
						</div><!-- s-left -->
					...
					<div class="sided-70 mb-50">
						...
						<div class="s-left rounded">
							<img src="{{ ('assets/frontend/images/profile-2-120x120.jpg')}}" alt="">
						</div><!-- s-left -->
